...
var testBlogPosts = [
  {
    id: 1,
    imageName: "Holi_FP_B118_1004194166.jpg",
  ...
  {
    id: 2,
    imageName: "Outdoor_99D_B022_100365573.jpg",
  ...
  {
    id: 3,
    imageName: "smart home_110110747.jpg",
...
app.delete("/blog/:id", (req, res) => {
  const { id } = req.params;
  testBlogPosts = testBlogPosts.filter((post) => post.id !== parseInt(id));
  console.log(`Blog post ${id} deleted`);
